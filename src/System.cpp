...
void System::AddWire(wire_t wire) {
//	wires.insert(pair<string, wire_t>(wire->GetName(), wire));
//
//	if (wire->IsInputWire()) {
//		// Add this wire to the list of input wires
//		// if we haven't done so already.
//		if (find(input_wires.begin(),
//				 input_wires.end(),
//				 wire) == input_wires.end())
//		{
//			input_wires.emplace_back(wire);
//		}
//	} else if (wire->IsOutputWire()) {
//		// Since outputs can only be driven by one
//		// component only, we do not have to check if
//		// we already have this wire in the list of
//		// output wires.
...
//		if (find(all_input_wires.begin(),
//				 all_input_wires.end(),
//				 wire) == all_input_wires.end())
//		{
//			all_input_wires.emplace_back(wire);
//		}
//	} else if (wire->IsOutputWire()) {
//		if (find(all_output_wires.begin(),
//				 all_output_wires.end(),
//				 wire) == all_output_wires.end())
//		{
//			all_output_wires.emplace_back(wire);
//		}
//	}
}

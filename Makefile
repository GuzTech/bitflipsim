...
OBJDIR := obj
OBJS := $(addprefix $(OBJDIR)/, Component.o FullAdder.o HalfAdder.o RippleCarryAdder.o Multiplier_2C.o Multiplier_Smag.o And.o Or.o Xor.o Nand.o Nor.o Xnor.o Not.o Mux.o Wire.o System.o main.o)
